...
> 2026-09-06：重新复现了无候选误判 FAILED、属性/任意备注猜配、跨账户 ID 排除三项回归。已改为证据不足保留 UNKNOWN、仅接受已发送 clientOrderId 回显、按完整账户作用域排除已认领 ID；52 项对账测试通过。旧关闭声明不再代表当前完整验收，详见[行为复核 R1–R3](../2026-09-06-behavior-audit.md)。
