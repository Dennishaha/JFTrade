...
| 系统诊断 | SystemPage、OpenD health、运行时依赖、存储概览、观测摘要 | 工程排障能力不错 |
...
[docs/troubleshooting/opend-configuration.md](troubleshooting/opend-configuration.md)、[docs/troubleshooting/live-stream-connection.md](troubleshooting/live-stream-connection.md)、SystemPage/OpenD health 说明运行诊断能力已经较认真。
...
- [apps/web/src/components/PageHeader.vue](../apps/web/src/components/PageHeader.vue)
