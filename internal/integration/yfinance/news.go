...
// News returns recent news entries for an instrument across all four markets.
...
// CorporateActions returns dividend and split events for an instrument.
