...
func TestDeleteGroupNeverPartiallyRemovesWatchlistState(t *testing.T) {
	tests := []struct {
		name  string
...
func TestRemoteReplacementAndBindingRemovalKeepPriorStateOnStorageFailure(t *testing.T) {
