...
func newExecutionOrderStoreWithDB(dbPath string) (*Store, error) {
...
func newExecutionOrderStoreWithPersistence(persistence *sqliteStore) (*Store, error) {
...
func newExecutionOrderSQLiteStore(dbPath string) (*sqliteStore, error) {
...
func newExecutionOrderSQLiteStoreWithDeps(
	...
	store := &sqliteStore{db: db, path: trimmedPath}
...
func (s *sqliteStore) initializeOrValidateSchema() error {
