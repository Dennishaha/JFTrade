...
func cloneExecutionOrderSummary(in trdsrv.ExecutionOrder) trdsrv.ExecutionOrder {
	legs := make([]trdsrv.ExecutionOrderLeg, len(in.Legs))
...
func cloneExecutionOrderLeg(in trdsrv.ExecutionOrderLeg) trdsrv.ExecutionOrderLeg {
...
func cloneExecutionOrderEvent(in trdsrv.ExecutionOrderEvent) trdsrv.ExecutionOrderEvent {
