...
func (s *sqliteStore) loadOrders() ([]trdsrv.ExecutionOrder, error) {
...
func (s *sqliteStore) loadOrderLegs() (map[string][]trdsrv.ExecutionOrderLeg, error) {
...
func (s *sqliteStore) loadSeenFillKeys() ([]executionSeenFillRow, error) {
...
func (s *sqliteStore) loadSequences() (map[string]uint64, error) {
...
func (s *sqliteStore) persistOrder(order trdsrv.ExecutionOrder) error {
...
func (s *sqliteStore) persistOrderLegs(internalOrderID string, legs []trdsrv.ExecutionOrderLeg) error {
...
func (s *sqliteStore) persistEvent(event trdsrv.ExecutionOrderEvent) error {
...
func (s *sqliteStore) savePreview(record trdsrv.ExecutionPreviewRecord) error {
...
func (s *sqliteStore) savePredictionQuote(
...
func (s *sqliteStore) predictionQuote(
...
func (s *sqliteStore) consumePredictionQuote(
...
func (s *sqliteStore) consumePreview(
...
func (s *sqliteStore) persistSeenFillKey(fillKey string, createdAt string) error {
...
func (s *sqliteStore) persistSequence(name string, value uint64) error {
...
func (s *sqliteStore) deleteSeenFillKeysBefore(cutoff time.Time) error {
	if cutoff.IsZero() {
		return nil
	}
