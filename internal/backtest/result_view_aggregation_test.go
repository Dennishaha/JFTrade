...
func TestResultViewExposesWarningsAndFiltersChartSeries(t *testing.T) {
...
func TestResultViewAggregationDropsDamagedCandlesWithoutInventingVolume(t *testing.T) {
