...
func TestControlPlaneRetainsActivationAndBoundsRepeatedAuditEvents(t *testing.T) {
...
func TestControlPlaneTreatsEmptyStateAsFreshAndRejectsUnavailableMutations(t *testing.T) {
...
func TestControlPlaneKeepsStateWhenAtomicPersistenceCannotComplete(t *testing.T) {
