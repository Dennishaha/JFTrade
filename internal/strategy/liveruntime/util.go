...
func strategyRuntimeDisplayName(instance stratsrv.ManagedInstance, runner *symbolRuntime) string {
...
func strategyRuntimeSortedSymbols(symbols map[string]*symbolRuntime) []string {
