...
func TestStrategyRuntimeSymbolKeepsPollingAndLateTradeFailuresVisible(t *testing.T) {
	...
	var nilRuntime *symbolRuntime
	nilRuntime.syncClosedKLines()
	(&symbolRuntime{}).syncClosedKLines()
...
func TestStrategyRuntimeSymbolFallbacksAvoidPanicsDuringShutdown(t *testing.T) {
	var nilRuntime *symbolRuntime
	...
	(&symbolRuntime{}).handleRuntimeError(errors.New("late runtime callback"))
