...
func TestServiceReportsPersistenceAndMCPFailures(t *testing.T) {
...
func TestServiceRollsBackMCPOnSaveFailure(t *testing.T) {
	persistErr := errors.New("persist failed")
...
func TestServicePreservesSecurityAndMCPFallbacks(t *testing.T) {
