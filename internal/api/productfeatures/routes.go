...
func RegisterRoutes(api *gin.RouterGroup, svc *service.Service) {
	...
	research.GET("/instruments/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentProfile))
	research.GET("/financials/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentFinancials))
	research.GET("/valuation/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentValuation))
	research.GET("/analyst/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentAnalyst))
	research.GET("/ownership/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentOwnership))
	research.GET("/corporate-actions/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentCorporateAction))
	research.GET("/short-interest/:instrumentId", handleInstrumentResearchQuery(svc, service.InstrumentShortInterest))
	...
	research.GET("/calendars", handleCalendarQuery(svc))
	research.GET("/macro", handleQuery(svc, queryRoute{feature: broker.FeatureResearchMacro}))
	research.GET("/rankings", handleRankingsQuery(svc))
