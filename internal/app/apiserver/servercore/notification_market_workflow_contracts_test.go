...
func TestBusinessNotificationsAndOptionalSecurityFieldsPreserveWireSemantics(t *testing.T) {
	...
	if got := futuintegration.SecurityRefMap(nil); got != nil {
		t.Fatalf("nil security ref map = %#v", got)
	}
	if got := futuintegration.SecurityDetailsMap(nil); got != nil {
...
func TestRealTradeControlPathPrefersExplicitOverride(t *testing.T) {
...
type notificationTextStringer string

func (value notificationTextStringer) String() string { return string(value) }
