...
func TestServiceSkillRecoveryContracts(t *testing.T) {
...
func TestServiceAuditAndOptimizationStateRecovery(t *testing.T) {
...
func TestCancelOptimizationTaskPropagatesPersistenceFailure(t *testing.T) {
