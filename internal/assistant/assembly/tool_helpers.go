...
// StringOrDefault normalizes optional textual input at the application
// adapter boundary.
func StringOrDefault(value string, defaultValue string) string {
	return stringOrDefault(value, defaultValue)
}

// NowStringRFC3339Nano provides the timestamp format used by ADK tool
// responses and cross-domain adapter payloads.
func NowStringRFC3339Nano() string {
	return nowStringRFC3339Nano()
}
