...
- Route coverage remains integration-owned and currently derives `23 shadow / 238 cutover-test-only / 17 cutover-qualified / 0 remaining / 0 Rust production owner`.
