...
describe("Backtest page compact-UI coverage", () => {
  ...
  it("covers comparison native select change handlers and their guards", async () => {
  ...
  it("covers render-window fallbacks and order-table extras", async () => {
