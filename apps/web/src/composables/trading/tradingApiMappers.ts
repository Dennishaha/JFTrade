...
import type {
  ExecutionOrderDetailsDto,
  ExecutionOrderDto,
  ExecutionOrderEventsDto,
  ExecutionOrdersDto,
} from "@/contracts";

type ExecutionOrderWire = ExecutionOrderDto;
type ExecutionOrdersWire = ExecutionOrdersDto;
type ExecutionOrderDetailsWire = ExecutionOrderDetailsDto;
type ExecutionOrderEventsWire = ExecutionOrderEventsDto;
