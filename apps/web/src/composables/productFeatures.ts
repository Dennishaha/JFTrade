...
export type ProductFeatureProvider =
  components["schemas"]["broker.ProviderAttribution"];
export type ProductFeatureResult =
  components["schemas"]["broker.FeatureResult"];

type ProductFeatureGetPath = {
  [TPath in keyof paths]: "get" extends keyof paths[TPath] ? TPath : never;
}[keyof paths] & string;
...
] as const satisfies ReadonlyArray<readonly [RegExp, ProductFeatureGetPath]>;
