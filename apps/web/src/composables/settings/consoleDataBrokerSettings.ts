...
export type { BrokerAccountSelectionOption } from "@/composables/trading/consoleDataBrokerAccountSelection";
...
export function createConsoleDataBrokerSettingsController(
  ...
  function resolveSelectedBrokerAccountOption(
    selectionOptions: readonly import("@/composables/trading/consoleDataBrokerAccountSelection").BrokerAccountSelectionOption[],
    activeBrokerId: string,
  ...
  function resolveBrokerQuery(
    selection: import("@/composables/trading/consoleDataBrokerAccountSelection").BrokerAccountSelectionOption | null,
  ) {
