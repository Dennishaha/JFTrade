...
type PluginCatalogWire = components["schemas"]["strategy.PluginCatalog"];
type PluginCompatibilityWire =
  components["schemas"]["strategy.PluginCompatibility"];
type PluginMutationWire = components["schemas"]["strategy.PluginMutationData"];
type PluginOperationWire = components["schemas"]["strategy.PluginOperation"];
type PluginUninstallGuidanceWire =
  components["schemas"]["strategy.PluginUninstallGuidance"];
...
export function mapPluginUninstallGuidance(
  value: PluginUninstallGuidanceWire,
