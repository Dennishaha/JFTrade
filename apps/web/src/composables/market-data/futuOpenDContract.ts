...
import type {
  FutuOpenDHealthResponseDto,
  FutuOpenDInstallGuideResponseDto,
} from "@/contracts";

type HealthWire = FutuOpenDHealthResponseDto;
type InstallGuideWire = FutuOpenDInstallGuideResponseDto;
