...
import { apiGet, apiPost } from "@/composables/shared/apiClient";
...
import type { MarketProfilesWire } from "@/composables/market-data/marketDataContract";
...
let marketProfilesLoadGeneration = 0;
...
export async function loadMarketProfiles(): Promise<void> {
  ...
  marketProfilesLoadPromise = (async () => {
    try {
      ...
      if (generation === marketProfilesLoadGeneration) {
