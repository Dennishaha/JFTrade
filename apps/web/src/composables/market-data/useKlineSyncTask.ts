...
import type { BacktestSyncRequestDto } from "@/contracts";

import { apiDeletePath, apiGetPath, apiPost } from "@/composables/shared/apiClient";
import { createBacktestLiveReducer } from "@/composables/market-data/liveEventReducers";
...
type BacktestSyncRequestWire = BacktestSyncRequestDto;
