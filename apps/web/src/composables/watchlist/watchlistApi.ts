...
import type {
  WatchlistGroupDto,
  WatchlistGroupsDto,
  WatchlistImportDiffItemDto,
  WatchlistImportRunDto,
  WatchlistItemsDto,
  WatchlistMembershipsDto,
} from "@/contracts";
...
type RawGroup = WatchlistGroupDto;
type RawMembership = WatchlistMembershipsDto;
...
function normalizeGroupsResponse(response: WatchlistGroupsDto): WatchlistGroup[] {
...
function normalizeImportDiffItem(
  item: WatchlistImportDiffItemDto,
) {
  return {
    instrumentId: item.instrumentId ?? "",
