...
import { mapOnboardingState } from "@/composables/settings/onboardingContract";
import {
  createConsoleDataBrokerSettingsController,
} from "@/composables/settings/consoleDataBrokerSettings";
import {
  createConsoleDataBrokerLiveQueryController,
} from "@/composables/market-data/consoleDataBrokerLiveQuery";
import {
  createConsoleDataConsoleStreamController,
} from "@/composables/market-data/consoleDataConsoleStream";
import {
  createConsoleDataExecutionOrdersController,
} from "@/composables/trading/consoleDataExecutionOrders";
import {
  createConsoleDataMarketDataSlice,
} from "@/composables/market-data/consoleDataMarketData";
import {
  createConsoleDataMarketDataQuerySlice,
} from "@/composables/market-data/consoleDataMarketDataQuery";
import { createStableWebConsumerId } from "@/composables/market-data/consoleDataMarketSubscriptions";
import {
  createConsoleDataPluginController,
} from "@/composables/workspace/consoleDataPlugins";
import {
  createConsoleDataPortfolioLiveQueryController,
} from "@/composables/trading/consoleDataPortfolioLiveQuery";
import {
  createConsoleDataSystemStateController,
  type MarketInstrumentReference,
} from "@/composables/settings/consoleDataSystemState";
import {
  createConsoleDataRealTradeController,
} from "@/composables/trading/consoleDataRealTrade";
import {
