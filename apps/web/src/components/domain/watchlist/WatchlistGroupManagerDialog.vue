...
.watchlist-groups-dialog__group-name strong { font-size: var(--jf-text-6); }
.watchlist-groups-dialog__group-name small { color: var(--tv-text-dim); font-size: var(--jf-text-4); }
.watchlist-groups-dialog__actions { display: flex; gap: 5px; }
.watchlist-groups-dialog__actions button { padding: 5px 7px; border: 1px solid var(--tv-border); border-radius: 5px; background: var(--tv-bg-surface); color: var(--tv-text-muted); font-size: var(--jf-text-4); }
.watchlist-groups-dialog__actions .is-danger:not(:disabled) { color: var(--tv-status-error-fg); }
.watchlist-groups-dialog__error { margin: 0; font-size: var(--jf-text-5); }
