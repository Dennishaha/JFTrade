...
import type {
  ExchangeCalendarMarketDto,
  ExchangeCalendarProbeItemDto,
  ExchangeCalendarProbeResponseDto,
  ExchangeCalendarRefreshResponseDto,
  ExchangeCalendarSettings as ExchangeCalendarSettingsDto,
  ExchangeCalendarSourceDto,
  ExchangeCalendarStatusResponseDto,
} from "@/contracts";
import {
  apiGet,
  apiPostPathAction,
...
type ExchangeCalendarSettings = ExchangeCalendarSettingsDto;
type CalendarMarketStatus = ExchangeCalendarMarketDto;
type CalendarSourceStatus = ExchangeCalendarSourceDto;
type CalendarStatusResponse = ExchangeCalendarStatusResponseDto;
type CalendarProbeResult = ExchangeCalendarProbeItemDto;
type CalendarProbeResponse = ExchangeCalendarProbeResponseDto;
type CalendarRefreshResponse = ExchangeCalendarRefreshResponseDto;
