...
.adk-input-card h3 { margin: 2px 0 0; color: var(--tv-text); font-size: var(--jf-text-8); line-height: 1.35; }
.adk-input-card__eyebrow { color: var(--adk-accent-fg); font-size: var(--jf-text-5); font-weight: 700; }
.adk-input-card__status { align-self: flex-start; border-radius: 999px; background: var(--adk-accent-bg-soft); color: var(--adk-accent-fg); padding: 3px 8px; font-size: var(--jf-text-5); font-weight: 700; white-space: nowrap; }
...
.adk-input-card__question-nav button { display: grid; place-items: center; width: 24px; height: 24px; border: 1px solid var(--tv-border); border-radius: 7px; background: var(--tv-bg-app); color: var(--tv-text-muted); font-size: var(--jf-text-5); font-weight: 700; }
...
.adk-input-card__question-nav > span { margin-left: auto; color: var(--tv-text-muted); font-size: var(--jf-text-5); font-variant-numeric: tabular-nums; }
fieldset { min-width: 0; margin: 0; padding: 0; border: 0; display: grid; gap: 6px; }
legend { width: 100%; margin-bottom: 2px; color: var(--tv-text); font-size: var(--jf-text-7); font-weight: 700; line-height: 1.4; }
...
.adk-input-option__body strong { color: var(--tv-text); font-size: var(--jf-text-6); line-height: 1.35; }
.adk-input-option__body small { margin-left: 4px; color: var(--adk-accent-fg); font-size: var(--jf-text-4); }
.adk-input-option__body > span { color: var(--tv-text-muted); font-size: var(--jf-text-5); line-height: 1.4; }
...
.adk-input-other > button { display: flex; align-items: center; gap: 8px; width: 100%; border: 0; background: transparent; padding: 1px 0 6px; color: var(--tv-text); text-align: left; font-size: var(--jf-text-6); }
.adk-input-other textarea { width: 100%; resize: vertical; border: 1px solid var(--tv-border-strong); border-radius: 7px; padding: 7px 8px; background: var(--tv-bg-app); color: var(--tv-text); font: inherit; font-size: var(--jf-text-6); line-height: 1.4; }
.adk-input-other textarea:focus { outline: 2px solid color-mix(in srgb, var(--tv-accent) 55%, transparent); outline-offset: 1px; }
.adk-input-card footer { display: flex; justify-content: space-between; align-items: center; gap: 12px; padding: 10px 14px; border-top: 1px solid var(--tv-border); color: var(--tv-text-muted); font-size: var(--jf-text-5); }
.adk-input-card footer button { border: 1px solid var(--adk-accent-border); border-radius: 8px; background: var(--adk-accent-bg); color: var(--adk-accent-fg); padding: 7px 11px; font-size: var(--jf-text-6); font-weight: 700; }
