    ...
    <div class="grid gap-4 lg:grid-cols-[1fr_1fr]">
        <div class="rounded-[28px] border border-slate-200 bg-slate-50/70 p-4">
            <div class="flex items-center justify-between gap-3">
                ...
                <span
                    class="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold uppercase tracking-(--jf-tracking-9) text-slate-600"
                >
            ...
            <div class="mt-4 grid gap-3 md:grid-cols-3">
                <div class="rounded-3xl bg-white px-4 py-4">
                    <div class="text-xs uppercase tracking-(--jf-tracking-10) text-slate-500">交易环境</div>
                    <div class="mt-2 text-2xl font-semibold text-slate-900">
                        {{ systemStatus.defaultTradingEnvironment }}
                    </div>
                </div>
                <div class="rounded-3xl bg-white px-4 py-4">
                    <div class="text-xs uppercase tracking-(--jf-tracking-10) text-slate-500">当前策略</div>
                    <div class="mt-2 text-xl font-semibold text-slate-900">
                        {{ selectedStrategy?.definition.name ?? "暂无" }}
                    </div>
                </div>
                <div class="rounded-3xl bg-white px-4 py-4">
                    <div class="text-xs uppercase tracking-(--jf-tracking-10) text-slate-500">运行形态</div>
        ...
        <div class="rounded-[28px] border border-slate-200 bg-slate-50/70 p-4">
            ...
            <div class="mt-4 grid gap-3 md:grid-cols-3">
                <div class="rounded-3xl bg-white px-4 py-4">
                    <div class="text-xs uppercase tracking-(--jf-tracking-10) text-slate-500">实盘开关</div>
                    <div class="mt-2 text-xl font-semibold text-slate-900">
                        {{ systemStatus.realTradingEnabled ? "已开启" : "已关闭" }}
                    </div>
                </div>
                <div class="rounded-3xl bg-white px-4 py-4">
                    <div class="text-xs uppercase tracking-(--jf-tracking-10) text-slate-500">急停开关</div>
                    <div
                ...
                <div class="rounded-3xl bg-white px-4 py-4">
                    <div class="text-xs uppercase tracking-(--jf-tracking-10) text-slate-500">策略动态风控</div>
