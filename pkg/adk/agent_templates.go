	...
	return []AgentWriteRequest{
		{
			...
			PermissionMode: PermissionModeApproval, Status: AgentStatusEnabled, MemoryEnabled: true,
			Tools:  []string{"system.status", "tools.search", "market.snapshot", "market.candles", "market.depth", "portfolio.summary", "broker.orders", "broker.fills", "risk.state", "strategy.dsl_spec", "strategy.validate_dsl", "strategy.save_definition", "strategy.update_instance_mode", "tasks.create", "tasks.update", "tasks.delete", "tasks.list", "memory.list", "memory.remember", "memory.forget"},
		...
		},
		{
			...
			PermissionMode: PermissionModeApproval, Status: AgentStatusEnabled, MemoryEnabled: true,
			Tools:  []string{"tools.search", "strategy.definitions", "strategy.dsl_spec", "strategy.validate_dsl", "strategy.save_draft", "strategy.save_definition", "strategy.update_instance_mode", "backtest.runs", "strategy.optimize", "market.snapshot", "market.candles", "tasks.create", "tasks.update", "tasks.delete", "tasks.list", "memory.list", "memory.remember", "memory.forget"},
		...
		},
		{
			...
			PermissionMode: PermissionModeApproval, Status: AgentStatusEnabled, MemoryEnabled: true,
			Tools:  []string{"system.status", "risk.state", "risk.events", "portfolio.summary", "broker.orders", "broker.fills", "broker.fees", "broker.margin_ratios", "execution.order_events", "strategy.dsl_spec", "strategy.validate_dsl", "strategy.save_definition", "strategy.update_instance_mode", "tasks.create", "tasks.update", "tasks.delete", "tasks.list", "memory.list", "memory.remember", "memory.forget"},
