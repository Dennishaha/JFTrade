	...
	return []AgentWriteRequest{
		{
			...
			Tools:  []string{"system.status", "tools.search", "market.snapshot", "market.candles", "market.depth", "portfolio.summary", "broker.orders", "broker.fills", "risk.state", "tasks.create", "tasks.update", "tasks.delete", "tasks.list", "memory.list", "memory.remember", "memory.forget"},
		...
		},
		{
			...
			PermissionMode: PermissionModeApproval, Status: AgentStatusEnabled, MemoryEnabled: true,
			Tools:  []string{"tools.search", "strategy.definitions", "strategy.save_draft", "backtest.runs", "strategy.optimize", "market.snapshot", "market.candles", "tasks.create", "tasks.update", "tasks.delete", "tasks.list", "memory.list", "memory.remember", "memory.forget"},
		...
		},
		{
			...
			PermissionMode: PermissionModeApproval, Status: AgentStatusEnabled, MemoryEnabled: true,
			Tools:  []string{"system.status", "risk.state", "risk.events", "portfolio.summary", "broker.orders", "broker.fills", "broker.fees", "broker.margin_ratios", "execution.order_events", "tasks.create", "tasks.update", "tasks.delete", "tasks.list", "memory.list", "memory.remember", "memory.forget"},
