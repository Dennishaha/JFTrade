...
func (s *Store) ensureBuiltins(ctx context.Context) error {
	builtins := []Skill{
		...
		{ID: "jftrade-strategy", DisplayName: "JFTrade 策略系统", Description: "策略建议必须区分草稿、回测和运行状态；不得承诺收益，写入和优化动作遵守审批模式。", Source: "builtin", Enabled: true, Builtin: true, Tools: []string{"strategy.definitions", "strategy.save_draft", "backtest.runs", "strategy.optimize"}, Version: "1", ValidationStatus: "VALID"},
