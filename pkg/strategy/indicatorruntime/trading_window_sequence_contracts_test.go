...
func TestTradingWindowSequenceSnapshotsRetainCurrentAndPreviousSessions(t *testing.T) {
...
func TestTradingWindowHMAIgnoresNonTradingGapsInsideSelectedRange(t *testing.T) {
