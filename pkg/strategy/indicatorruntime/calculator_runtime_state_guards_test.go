...
func TestCalculatorGuardsRejectUnwarmedAndMalformedSeries(t *testing.T) {
...
func TestVWAPAndRollingStateGuardContracts(t *testing.T) {
...
func TestRollingIndicatorStateFailuresStayUnavailable(t *testing.T) {
...
func TestVWAPAndEngineWarmupKeepUnavailableValuesExplicit(t *testing.T) {
	at := time.Date(2026, time.January, 5, 15, 0, 0, 0, time.UTC)
...
func TestRequirementAccountingAndIndicatorKeysStayDeterministic(t *testing.T) {
...
func TestRiskAndSnapshotHelpersRejectCorruptedData(t *testing.T) {
...
func TestRuntimeStateFallbacksDoNotInventValues(t *testing.T) {
