...
func TestSnapshotAssemblyOmitsIncompleteDataAndPreservesLegacyMAKey(t *testing.T) {
...
func TestHistoricalDivergenceFallbackMatchesStoredSeries(t *testing.T) {
...
func TestRollingStatesRecoverWithoutProducingInventedSignals(t *testing.T) {
...
func TestAdvancedSnapshotsRejectUnavailableOrInsufficientSeries(t *testing.T) {
