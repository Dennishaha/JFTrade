...
func TestAdvancedParserRejectsEveryMalformedShape(t *testing.T) {
...
func TestFixedTimeframeValidationReportsEveryIndicatorFamily(t *testing.T) {
...
func TestMovingAverageHelpersRejectInsufficientInput(t *testing.T) {
...
func TestTradingPeriodHelpersRejectInvalidSelections(t *testing.T) {
...
func TestSnapshotReadersAndRollingBuffersHandleEmptyState(t *testing.T) {
...
func TestOscillatorAndVWAPHelpersCoverFlatAndInvalidSeries(t *testing.T) {
