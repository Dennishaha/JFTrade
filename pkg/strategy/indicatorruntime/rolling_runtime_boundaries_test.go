...
func TestRollingStatesRejectIncompleteMarketInputs(t *testing.T) {
...
func TestRollingStochasticHandlesFlatAndMalformedSeries(t *testing.T) {
...
func TestBollingerStateKeepsPartialWindowsOutOfSignals(t *testing.T) {
...
func TestTradingWindowMovingAveragesRejectIncompletePeriods(t *testing.T) {
...
func TestIndicatorRuntimeHelpersPreserveSlicesAndFallbacks(t *testing.T) {
