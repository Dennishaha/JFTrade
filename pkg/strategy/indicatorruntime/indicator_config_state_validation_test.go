...
func TestIndicatorConfigParsingRejectsMalformedRiskAndTimeframeInputs(t *testing.T) {
...
func TestRollingIndicatorStatesDistinguishUnwarmedAndInvalidSeries(t *testing.T) {
