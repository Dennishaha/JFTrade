...
func TestSnapshotPreparationAndFallbackFamilies(t *testing.T) {
...
func TestTradingWindowAndStopLossFallbackPaths(t *testing.T) {
	endTimes := []time.Time{
...
func TestAdvancedRuntimeFailureAndKeltnerCases(t *testing.T) {
	runtime := &indicatorRuntime{
		intervalMinutes: 1,
