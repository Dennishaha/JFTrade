...
func TestTradingWindowAlgorithmsKeepSessionBoundariesAndFailureSignals(t *testing.T) {
...
func TestTradingWindowOnlineAggregatorsRejectMissingVolumeWithoutChangingWindowSemantics(t *testing.T) {
...
func TestAdvancedIndicatorAndFormulaFailurePathsStayExplicit(t *testing.T) {
