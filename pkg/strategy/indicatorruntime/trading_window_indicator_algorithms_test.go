...
func TestTradingWindowMathPreservesFailureSemantics(t *testing.T) {
...
func TestIndicatorConfigValidationKeepsInvalidBusinessInputOut(t *testing.T) {
...
func TestAlgorithmBoundariesRemainSafeForRiskAndAdvancedIndicators(t *testing.T) {
