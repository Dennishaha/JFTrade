...
func TestTradingWindowCompatibilityKeepsUnavailableInputsDistinct(t *testing.T) {
...
func TestTradingWindowSequenceHandlesInvalidLabelsAndUnsupportedAccumulators(t *testing.T) {
	values := []float64{10, 20, 30}
