...
func TestStateFactoriesRejectInvalidConfigurations(t *testing.T) {
...
func TestRollingKDJStateRemainsCoherentAfterSeriesTrim(t *testing.T) {
...
func TestRollingEmaMacdAndMovingAverageBoundaryValues(t *testing.T) {
...
func TestRuntimeHelpersCoverTimeframesAndSecurityValues(t *testing.T) {
...
func TestRuntimePushTrimsAlignedSeriesAndStopLossModes(t *testing.T) {
	runtime := &indicatorRuntime{
		symbol:              "US.AAPL",
		intervalMinutes:     1,
		seriesLimit:         2,
