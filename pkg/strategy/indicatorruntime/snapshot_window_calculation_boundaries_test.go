...
func TestNilSnapshotCachePreservesSnapshotValues(t *testing.T) {
...
func TestSnapshotCacheResetsAndUpdatesCachedFamilies(t *testing.T) {
...
func TestSeriesLimitAndIntervalInputVariants(t *testing.T) {
...
func TestTradingPeriodAndWindowSelectionBehavior(t *testing.T) {
	endTimes := []time.Time{
...
func TestTradingWindowSequenceAndAggregatorFailures(t *testing.T) {
...
func TestAdvancedCalculationsCoverInvalidAndDegenerateData(t *testing.T) {
...
func TestParsingRejectsMalformedBusinessKeys(t *testing.T) {
