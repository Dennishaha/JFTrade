...
var capabilityDefinitions = []capabilityDefinition{
	...
	supportedCapability("request.security.extended_ticker_heikinashi"),
...
func capabilityHasFrontend(id string) bool {
	...
	case "indicator.ma", "indicator.rsi", "indicator.macd", "indicator.atr",
		...
		"request.security.extended_ticker_heikinashi",
...
var capabilityTestIDEvidence = map[string][]string{
	...
	"request.security.extended_ticker_heikinashi":             {"TestExtendedTickerRequestSecuritySupportsCurrentSymbolOnly", "TestCompileAcceptsExtendedTickerAndChartFlags"},
...
var currentCapabilityEvidenceTests = map[string]bool{
	...
	"TestCompileAcceptsExtendedTickerAndChartFlags":                              true,
	...
	"TestExtendedTickerRequestSecuritySupportsCurrentSymbolOnly":                 true,
