...
var semanticFunctionSignatures = map[string]semanticSignature{
	...
	"ticker.heikinashi":                  {minArgs: 1, maxArgs: 1, signature: "ticker.heikinashi(syminfo.tickerid)", returnKind: SemanticValueSimple},
	"ticker.standard":                    {minArgs: 0, maxArgs: 1, signature: "ticker.standard(syminfo.tickerid?)", returnKind: SemanticValueSimple},
	"ticker.inherit":                     {minArgs: 2, maxArgs: 2, signature: "ticker.inherit(from_tickerid, syminfo.tickerid)", returnKind: SemanticValueSimple},
	"request.security":                   {minArgs: 3, maxArgs: 5, signature: "request.security(syminfo.tickerid | ticker.heikinashi/standard/inherit(...), timeframe, expression, gaps?, lookahead?)", returnKind: SemanticValueSeries},
