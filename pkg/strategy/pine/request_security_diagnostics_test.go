...
func TestRequestSecurityDiagnosticsRejectUnsafeOrAmbiguousInputs(t *testing.T) {
	cases := []struct {
		name string
		line string
		code string
...
func TestRequestSecurityLoweringRetainsOnlyPureStaticExpressions(t *testing.T) {
