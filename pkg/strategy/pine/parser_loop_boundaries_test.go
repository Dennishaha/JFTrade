...
func TestMalformedNamespaceCallsRemainVisibleForValidation(t *testing.T) {
	tests := []struct {
		name       string
		expression string
...
func TestStaticLoopBoundsRejectNonTerminatingUserRanges(t *testing.T) {
...
func TestTupleIndicatorsExposeUnsupportedCallHistory(t *testing.T) {
