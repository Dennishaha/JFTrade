...
func TestUnsupportedSyntaxDiagnosticsDescribeUnsafeRequestSecurityContracts(t *testing.T) {
...
func TestTupleHelpersRejectMalformedIndicatorArityWithoutInventingAliases(t *testing.T) {
...
func TestTALoweringLeavesMalformedCallsUntouched(t *testing.T) {
	for _, tc := range []struct {
		name string
		got  func() string
		want string
