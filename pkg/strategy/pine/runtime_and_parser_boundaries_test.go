...
func TestOrderAndParserBoundaryContracts(t *testing.T) {
...
func TestDynamicForBoundsUseRuntimeFallback(t *testing.T) {
...
func TestNormalizationPreservesInvalidUserSyntaxAndErrors(t *testing.T) {
...
func TestMalformedTAExpressionsRemainVisibleForValidation(t *testing.T) {
	for _, tc := range []struct {
		name string
		got  string
		want string
...
func TestControlFlowErrorsRemainActionableBeforeRuntime(t *testing.T) {
