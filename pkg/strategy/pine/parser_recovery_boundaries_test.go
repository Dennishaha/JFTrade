...
func TestParserRejectsMalformedUDFAndStatementBoundaries(t *testing.T) {
...
func TestObjectArgumentRecoveryRejectsOverrunAndPreservesDefaults(t *testing.T) {
...
func TestCollectionScannerRejectsDamagedAndUnknownCalls(t *testing.T) {
	state := newObjectCollectionBoundaryParseState()
