...
func TestObjectAndCollectionParserFailureContracts(t *testing.T) {
...
func TestRequestSecurityAndTupleContractsRejectUnsafeExpressions(t *testing.T) {
	for _, tc := range []struct {
		name string
		args []string
		ok   bool
...
func TestOrderAndTupleHelperContractsKeepTradeInstructionsUnambiguous(t *testing.T) {
