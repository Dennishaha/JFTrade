...
func TestIncompleteColorAndRequestCallsRemainRecoverable(t *testing.T) {
...
func TestUDFExpansionRetainsWhitespaceAndUnwindsRejectedArguments(t *testing.T) {
...
func TestMethodAndControlFlowFailuresKeepSourceContracts(t *testing.T) {
...
func TestNestedLoopStateAndImportRecoveryRemainStable(t *testing.T) {
...
func TestOrderAndTupleErrorsPreserveExecutableBoundaries(t *testing.T) {
...
func TestOrderCallsRejectUnknownNamedArgumentsBeforePlanning(t *testing.T) {
	state := newParseState("", nil, nil)
	for _, tc := range []struct {
		name string
		call func() error
...
func TestSourceAnnotationsAndCommentsKeepTheirSeparateRoles(t *testing.T) {
