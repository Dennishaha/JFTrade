...
func TestRequestSecurityPurityRejectsUnsafeLoweredExpressions(t *testing.T) {
...
func TestRequestSecurityRejectsMalformedAdvancedIndicatorArguments(t *testing.T) {
