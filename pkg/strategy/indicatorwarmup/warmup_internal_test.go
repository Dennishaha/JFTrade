...
func TestResolveIntervalMinutesSupportsBrokerIntervalsAndSafeFallbacks(t *testing.T) {
	tests := []struct {
		...
		{"5m", 5},
		{"2h", 120},
		{"2d", 2 * tradingSessionMinutesPerDay},
		{"2w", 2 * tradingSessionMinutesPerWeek},
		{"2mo", 2 * tradingSessionMinutesPerMonth},
		{"bad", 1},
		{"0m", 1},
		{"xm", 1},
	}
