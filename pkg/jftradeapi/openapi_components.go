	...
	return map[string]any{
		"schemas": map[string]any{
			...
			"StrategyDefinition": map[string]any{
				"type": "object",
				"properties": map[string]any{
					"id":          map[string]any{"type": "string", "example": "js-mean-revert"},
					"name":        map[string]any{"type": "string", "example": "JS Mean Revert"},
					"version":     map[string]any{"type": "string", "example": "0.1.0"},
					"description": map[string]any{"type": "string", "example": "使用 QuickJS 的最小均值回归策略"},
					"runtime":     map[string]any{"type": "string", "example": "quickjs-js"},
					"symbol":      map[string]any{"type": "string", "example": "00700"},
					"interval":    map[string]any{"type": "string", "example": "1m"},
					"script":      map[string]any{"type": "string", "example": "function onKLineClosed(ctx) { console.log(ctx.kline.close); }"},
					"visualModel": schemaRef("StrategyVisualModel"),
					"createdAt":   map[string]any{"type": "string", "format": "date-time"},
					"updatedAt":   map[string]any{"type": "string", "format": "date-time"},
				},
				"required": []string{"id", "name", "version", "runtime", "symbol", "interval", "script", "createdAt", "updatedAt"},
			},
