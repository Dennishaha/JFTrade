...
func TestPineWorkerRunnerRejectsInvalidConfigurationBeforeReplay(t *testing.T) {
...
func TestPineWorkerRunnerReplayStopsOnIntegrityFailures(t *testing.T) {
...
func TestPineWorkerRunnerFailsClosedForInvalidWorkerCommandsDuringReplay(t *testing.T) {
