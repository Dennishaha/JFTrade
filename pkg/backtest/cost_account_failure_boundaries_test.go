...
func TestFeeSchedulePreservesExplicitPresetIntentAndSafeEmptyFallback(t *testing.T) {
...
func TestFeeEngineRejectsNonBillableTradesAndDoesNotDoubleChargeOrderFee(t *testing.T) {
	result := &RunResult{}
...
func TestAccountReadFailureDoesNotCreateSpeculativeEquityPoint(t *testing.T) {
	result := &RunResult{}
...
func TestPrepareKLineErrorClassifierRequiresBothStableFragments(t *testing.T) {
