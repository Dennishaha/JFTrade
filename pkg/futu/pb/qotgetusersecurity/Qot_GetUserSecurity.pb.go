...
const file_Qot_GetUserSecurity_proto_rawDesc = "" +
	"\n" +
	"\x19Qot_GetUserSecurity.proto\x12\x13Qot_GetUserSecurity\x1a\fCommon.proto\x1a\x10Qot_Common.proto\"R\n" +
	"\x03C2S\x12\x1c\n" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x18.Qot_GetUserSecurity.S2CR\x03s2cBh\n" +
	"\x13com.futu.openapi.pbZQgithub.com/jftrade/jftrade-main/pkg/futu/pb/qotgetusersecurity;qotgetusersecurity"
...
var file_Qot_GetUserSecurity_proto_depIdxs = []int32{
	4, // 0: Qot_GetUserSecurity.C2S.header:type_name -> Qot_Common.QotHeader
	5, // 1: Qot_GetUserSecurity.S2C.staticInfoList:type_name -> Qot_Common.SecurityStaticInfo
	0, // 2: Qot_GetUserSecurity.Request.c2s:type_name -> Qot_GetUserSecurity.C2S
	1, // 3: Qot_GetUserSecurity.Response.s2c:type_name -> Qot_GetUserSecurity.S2C
