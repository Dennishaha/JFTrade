...
const file_Qot_GetHistoryKL_proto_rawDesc = "" +
	"\n" +
	"\x16Qot_GetHistoryKL.proto\x12\x10Qot_GetHistoryKL\x1a\fCommon.proto\x1a\x10Qot_Common.proto\"\xa2\x02\n" +
	"\x03C2S\x12\x1c\n" +
	...
	"\x06header\x18d \x01(\v2\x15.Qot_Common.QotHeaderR\x06header\"\xac\x01\n" +
	"\x03S2C\x120\n" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x15.Qot_GetHistoryKL.S2CR\x03s2cBb\n" +
	"\x13com.futu.openapi.pbZKgithub.com/jftrade/jftrade-main/pkg/futu/pb/qotgethistorykl;qotgethistorykl"
...
var file_Qot_GetHistoryKL_proto_depIdxs = []int32{
	...
	5, // 1: Qot_GetHistoryKL.C2S.header:type_name -> Qot_Common.QotHeader
	4, // 2: Qot_GetHistoryKL.S2C.security:type_name -> Qot_Common.Security
	6, // 3: Qot_GetHistoryKL.S2C.klList:type_name -> Qot_Common.KLine
	0, // 4: Qot_GetHistoryKL.Request.c2s:type_name -> Qot_GetHistoryKL.C2S
	1, // 5: Qot_GetHistoryKL.Response.s2c:type_name -> Qot_GetHistoryKL.S2C
