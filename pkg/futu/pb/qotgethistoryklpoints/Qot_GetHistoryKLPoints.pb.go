...
const file_Qot_GetHistoryKLPoints_proto_rawDesc = "" +
	"\n" +
	"\x1cQot_GetHistoryKLPoints.proto\x12\x16Qot_GetHistoryKLPoints\x1a\fCommon.proto\x1a\x10Qot_Common.proto\"\xba\x02\n" +
	"\x03C2S\x12\x1c\n" +
	...
	"\x10needKLFieldsFlag\x18\a \x01(\x03R\x10needKLFieldsFlag\x12-\n" +
	"\x06header\x18d \x01(\v2\x15.Qot_Common.QotHeaderR\x06header\"f\n" +
	...
	"\x0fDataStatus_Back\x10\x03Bn\n" +
	"\x13com.futu.openapi.pbZWgithub.com/jftrade/jftrade-main/pkg/futu/pb/qotgethistoryklpoints;qotgethistoryklpoints"
...
var file_Qot_GetHistoryKLPoints_proto_goTypes = []any{
	...
	(*qotcommon.KLine)(nil),         // 10: Qot_Common.KLine
}
var file_Qot_GetHistoryKLPoints_proto_depIdxs = []int32{
	...
	9,  // 1: Qot_GetHistoryKLPoints.C2S.header:type_name -> Qot_Common.QotHeader
	10, // 2: Qot_GetHistoryKLPoints.HistoryPointsKL.kl:type_name -> Qot_Common.KLine
	8,  // 3: Qot_GetHistoryKLPoints.SecurityHistoryKLPoints.security:type_name -> Qot_Common.Security
	3,  // 4: Qot_GetHistoryKLPoints.SecurityHistoryKLPoints.klList:type_name -> Qot_GetHistoryKLPoints.HistoryPointsKL
	4,  // 5: Qot_GetHistoryKLPoints.S2C.klPointList:type_name -> Qot_GetHistoryKLPoints.SecurityHistoryKLPoints
	2,  // 6: Qot_GetHistoryKLPoints.Request.c2s:type_name -> Qot_GetHistoryKLPoints.C2S
	5,  // 7: Qot_GetHistoryKLPoints.Response.s2c:type_name -> Qot_GetHistoryKLPoints.S2C
