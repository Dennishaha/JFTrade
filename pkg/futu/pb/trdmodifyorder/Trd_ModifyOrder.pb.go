...
const file_Trd_ModifyOrder_proto_rawDesc = "" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x14.Trd_ModifyOrder.S2CR\x03s2cB`\n" +
	"\x13com.futu.openapi.pbZIgithub.com/jftrade/jftrade-main/pkg/futu/pb/trdmodifyorder;trdmodifyorder"
