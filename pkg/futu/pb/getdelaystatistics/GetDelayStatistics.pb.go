...
const file_GetDelayStatistics_proto_rawDesc = "" +
	"\n" +
	"\x18GetDelayStatistics.proto\x12\x12GetDelayStatistics\x1a\fCommon.proto\"g\n" +
	"\x03C2S\x12\x1a\n" +
	...
	"proportion\x12(\n" +
	"\x0fcumulativeRatio\x18\x05 \x02(\x02R\x0fcumulativeRatio\"\xaa\x01\n" +
	"\x0fDelayStatistics\x12 \n" +
	"\vqotPushType\x18\x01 \x02(\x05R\vqotPushType\x12C\n" +
	"\bitemList\x18\x02 \x03(\v2'.GetDelayStatistics.DelayStatisticsItemR\bitemList\x12\x1a\n" +
	...
	"updateCost\"\xae\x02\n" +
	"\x03S2C\x12Y\n" +
	"\x15qotPushStatisticsList\x18\x01 \x03(\v2#.GetDelayStatistics.DelayStatisticsR\x15qotPushStatisticsList\x12b\n" +
	"\x16reqReplyStatisticsList\x18\x02 \x03(\v2*.GetDelayStatistics.ReqReplyStatisticsItemR\x16reqReplyStatisticsList\x12h\n" +
	"\x18placeOrderStatisticsList\x18\x03 \x03(\v2,.GetDelayStatistics.PlaceOrderStatisticsItemR\x18placeOrderStatisticsList\"4\n" +
	"\aRequest\x12)\n" +
	"\x03c2s\x18\x01 \x02(\v2\x17.GetDelayStatistics.C2SR\x03c2s\"\x87\x01\n" +
	"\bResponse\x12\x1e\n" +
	"\aretType\x18\x01 \x02(\x05:\x04-400R\aretType\x12\x16\n" +
	"\x06retMsg\x18\x02 \x01(\tR\x06retMsg\x12\x18\n" +
	"\aerrCode\x18\x03 \x01(\x05R\aerrCode\x12)\n" +
	"\x03s2c\x18\x04 \x01(\v2\x17.GetDelayStatistics.S2CR\x03s2c*\x9c\x01\n" +
	...
	"\x12QotPushType_Broker\x10\x04Bh\n" +
	"\x13com.futu.openapi.pbZQgithub.com/jftrade/jftrade-main/pkg/futu/pb/getdelaystatistics;getdelaystatistics"
