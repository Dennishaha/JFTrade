...
type C2S struct {
	...
	ParamStr      *string                `protobuf:"bytes,2,opt,name=paramStr" json:"paramStr,omitempty"`
	ParamBytes    []byte                 `protobuf:"bytes,3,opt,name=paramBytes" json:"paramBytes,omitempty"`
...
func (x *C2S) GetParamStr() string {
	if x != nil && x.ParamStr != nil {
		return *x.ParamStr
	}
	return ""
}

func (x *C2S) GetParamBytes() []byte {
	if x != nil {
		return x.ParamBytes
	}
	return nil
...
type S2C struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cmd           *string                `protobuf:"bytes,1,req,name=cmd" json:"cmd,omitempty"`
	ResultStr     *string                `protobuf:"bytes,2,opt,name=resultStr" json:"resultStr,omitempty"`
	ResultBytes   []byte                 `protobuf:"bytes,3,opt,name=resultBytes" json:"resultBytes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *S2C) GetResultStr() string {
	if x != nil && x.ResultStr != nil {
		return *x.ResultStr
	}
	return ""
}

func (x *S2C) GetResultBytes() []byte {
	if x != nil {
...
const file_TestCmd_proto_rawDesc = "" +
	"\n" +
	"\rTestCmd.proto\x12\aTestCmd\"S\n" +
	"\x03C2S\x12\x10\n" +
	"\x03cmd\x18\x01 \x02(\tR\x03cmd\x12\x1a\n" +
	"\bparamStr\x18\x02 \x01(\tR\bparamStr\x12\x1e\n" +
	"\n" +
	"paramBytes\x18\x03 \x01(\fR\n" +
	"paramBytes\"W\n" +
	"\x03S2C\x12\x10\n" +
	"\x03cmd\x18\x01 \x02(\tR\x03cmd\x12\x1c\n" +
	"\tresultStr\x18\x02 \x01(\tR\tresultStr\x12 \n" +
	"\vresultBytes\x18\x03 \x01(\fR\vresultBytes\")\n" +
	"\aRequest\x12\x1e\n" +
	...
	"\x03s2c\x18\x04 \x01(\v2\f.TestCmd.S2CR\x03s2cBR\n" +
	"\x13com.futu.openapi.pbZ;github.com/jftrade/jftrade-main/pkg/futu/pb/testcmd;testcmd"
