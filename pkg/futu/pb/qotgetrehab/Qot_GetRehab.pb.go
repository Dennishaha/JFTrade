...
const file_Qot_GetRehab_proto_rawDesc = "" +
	"\n" +
	"\x12Qot_GetRehab.proto\x12\fQot_GetRehab\x1a\fCommon.proto\x1a\x10Qot_Common.proto\"n\n" +
	"\x03C2S\x128\n" +
	...
	"\x03s2c\x18\x04 \x01(\v2\x11.Qot_GetRehab.S2CR\x03s2cBZ\n" +
	"\x13com.futu.openapi.pbZCgithub.com/jftrade/jftrade-main/pkg/futu/pb/qotgetrehab;qotgetrehab"
...
var file_Qot_GetRehab_proto_goTypes = []any{
	...
	(*qotcommon.Rehab)(nil),     // 7: Qot_Common.Rehab
}
var file_Qot_GetRehab_proto_depIdxs = []int32{
	5, // 0: Qot_GetRehab.C2S.securityList:type_name -> Qot_Common.Security
	6, // 1: Qot_GetRehab.C2S.header:type_name -> Qot_Common.QotHeader
	5, // 2: Qot_GetRehab.SecurityRehab.security:type_name -> Qot_Common.Security
	7, // 3: Qot_GetRehab.SecurityRehab.rehabList:type_name -> Qot_Common.Rehab
	1, // 4: Qot_GetRehab.S2C.securityRehabList:type_name -> Qot_GetRehab.SecurityRehab
	0, // 5: Qot_GetRehab.Request.c2s:type_name -> Qot_GetRehab.C2S
	2, // 6: Qot_GetRehab.Response.s2c:type_name -> Qot_GetRehab.S2C
