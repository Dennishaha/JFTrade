...
export function stage3FixtureRoot(root = repositoryRoot) {
  return path.join(root, "tests/fixtures/rust-migration/stage3");
}
...
export function loadStage3Expected(root = repositoryRoot) {
...
export function runRustReference(root = repositoryRoot) {
  return JSON.parse(runProcess("cargo", [
    ...
    "jftrade-backtest",
    "--bin",
    "jftrade-backtest-shadow",
    "--",
    "--input",
    path.join(stage3FixtureRoot(root), "backtest-corpus.json"),
