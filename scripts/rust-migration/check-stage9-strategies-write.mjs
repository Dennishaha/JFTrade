...
run("cargo", [
  ...
  "jftrade-engine",
  "--test",
  "stage9_strategies_write",
  "--",
  "--nocapture",
]);
console.log(
  "Stage 9 strategies-write differential passed: Go fixture and Rust leaf replay agree for all seven strategy runtime mutation routes.",
);
