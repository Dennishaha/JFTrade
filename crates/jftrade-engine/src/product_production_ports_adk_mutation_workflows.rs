...
pub(super) fn dispatch(
    ...
    match input.operation {
            AdkMutationOperation::CreateWorkflow | AdkMutationOperation::UpdateWorkflow => {
                ...
                for key in [
                    "name", "description", "agentId", "workMode", "providerId", "model",
                    "permissionMode", "promptTemplate", "objectiveTemplate", "defaultInputs",
                    "canvasGraph", "tags", "builtinTemplate",
                ] {
                ...
                object.insert("promptTemplate".to_owned(), Value::String(prompt.to_owned()));
            ...
            AdkMutationOperation::UpdateWorkflowTrigger => {
                ...
                let trigger_type = normalize_trigger_type(
                    body.get("type"),
