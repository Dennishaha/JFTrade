...
use jftrade_store_sqlite::{
    ...
    CancelBacktestSyncResult, StoredBacktestSyncTask, StoredStrategyDefinition,
    StoredStrategyVersion, StrategyDefinitionStore, StrategyDefinitionStoreError,
};
