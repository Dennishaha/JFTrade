//! Provider runtime compatibility composition used by the frozen corpus replay.
...
pub struct ProviderRuntimeAssembly {
...
#[derive(Debug, Error)]
pub enum ProviderRuntimeAssemblyError {
    #[error(transparent)]
...
impl ProviderRuntimeAssembly {
    ...
    ) -> Result<Self, ProviderRuntimeAssemblyError> {
...
mod tests {
    ...
    fn assembly_keeps_provider_and_integration_owners_explicit() {
        ...
        let assembly = ProviderRuntimeAssembly::new(
            [(descriptor, health)],
            HelperClientConfig {
